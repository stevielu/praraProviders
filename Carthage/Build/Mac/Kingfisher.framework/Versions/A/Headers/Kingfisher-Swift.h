...
- (void)imageDownloader:(ImageDownloader * _Nonnull)downloader didDownloadImage:(NSImage * _Nonnull)image forURL:(NSURL * _Nonnull)URL withResponse:(NSURLResponse * _Nonnull)response;
@end
...
@property (nonatomic, readonly, strong) NSURL * _Nullable kf_alternateWebURL;
@end
...
@interface NSImage (SWIFT_EXTENSION(Kingfisher))
- (NSImage * _Nullable)kf_decodedImage;
- (NSImage * _Nullable)kf_decodedImageWithScale:(CGFloat)scale;
@end


@interface NSImage (SWIFT_EXTENSION(Kingfisher))
+ (NSImage * _Nullable)kf_animatedImageWithGIFDataWithGifData:(NSData * _Nonnull)data preloadAll:(BOOL)preloadAll;
+ (NSImage * _Nullable)kf_animatedImageWithGIFDataWithGifData:(NSData * _Nonnull)data scale:(CGFloat)scale duration:(NSTimeInterval)duration preloadAll:(BOOL)preloadAll;
@end
...
- (NSImage * _Nonnull)kf_normalizedImage;
+ (NSImage * _Nullable)kf_animatedImageWithImages:(NSArray<NSImage *> * _Nonnull)images duration:(NSTimeInterval)duration;
@end
...
@property (nonatomic, readonly, strong) NSProgressIndicator * _Nullable kf_indicator;
@end
